...
app.post('/transaction', function (req, res) {
      ...
      const blockIndex = beblock.addTransactionToPendingTransactions(newTransaction);
      res.json({
        note: `Transaction will be added in block ${blockIndex}`
      });

      app.post('/transaction/broadcast', function (req, res) {
        const newTransaction = beblock.createNewTransaction(req.body.amount, req.body.sender, req.body.recipient);
        beblock.addTransactionToPendingTransactions(newTransaction);
        ...
        Promise.all(requestPromises).then(data => {
          res.json({
            note: 'Transaction created and broadcast with succes'
          })
        });
      });
